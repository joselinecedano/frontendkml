...
to book in for a removal and a fresh set.<br/>§ Every fill in comes with a complimentary lash bath. If your lash extensions have any lash strip glue on them, it will be an automatic <span  className='text-red-500'>lash removal</span>.
              </p>
            </div>
          </div>
        </div>
